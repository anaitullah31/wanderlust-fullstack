...
const Banner = () => {
  return (
    <div className="bg-[url('/assets/Banner.png')] bg-no-repeat bg-cover bg-center text-white flex justify-between flex-col items-center gap-5 h-216">
      ...
      <div className=" bg-white/30 w-full">
        <div className="flex justify-between gap-5 max-w-7xl mx-auto items-center">
          <div className="px-3">
